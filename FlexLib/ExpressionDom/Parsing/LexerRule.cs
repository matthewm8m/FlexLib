...
namespace FlexLib.ExpressionDom.Parsing
{
    ...
    public class LexerRule
    {
        ...
        public virtual IEnumerable<Token> Tokenize(TokenSource source)
        {
        ...
        public override IEnumerable<Token> Tokenize(TokenSource source)
        {
            ...
            else
            {
                if (Parser(source.Snippet, out T value))
                    ...
                    throw new FormatException($"Regular expression and parser are incompatible in token definition: {this}");
            }
        }
    }
}